...
REAL (DP), PARAMETER :: mb1 = 1.78266191D-25

! Fermionic mass (electrons) for normal matter !			
REAL (DP), PARAMETER :: me1 = 1.78266191D-25
...
! Rotation law for NM !
INTEGER, PARAMETER :: rigid2 = 0
INTEGER, PARAMETER :: vconst2 = 0
INTEGER, PARAMETER :: jconst2 = 1
...
! Tolerance of error !
REAL (DP), PARAMETER :: tor = 1.0D-10

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

! Number of models per maximum density !
INTEGER, PARAMETER :: n_rho = 2

! Starting log maximum density !
REAL (DP), PARAMETER :: rhostart = 10.5D0

! Ending log maximum density !
REAL (DP), PARAMETER :: rhoend = 10.6D0
...
! Starting axis point !
INTEGER, PARAMETER :: axstart = 73 !NINT((DBLE(NDIV) - 1.0D0)/rmax + 1.0D0)

! Ending axis ratio !
INTEGER, PARAMETER :: axend = axstart - 1!1
...
INTEGER, PARAMETER :: omax = 60

! Maximum iteration in bisection method !
INTEGER, PARAMETER :: omax_min = 30

! Dark matter target mass !
REAL (DP), PARAMETER :: mass_dm = 0.1D0

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

! Skip models with critical rotations !
LOGICAL, PARAMETER :: critical_flag = .false.

! Want to output profile? !
LOGICAL, PARAMETER :: output_profile = .false.

! Want to output results? !
